<template>
    <view>
        <t-cell title="地址" :note="note" @click="showCascader" arrow />

        <t-cascader :close-btn="false" :check-strictly="true" :visible="visible" :value="value" :options="options" title="请选择地址" @change="onChange" @pick="onPick">
