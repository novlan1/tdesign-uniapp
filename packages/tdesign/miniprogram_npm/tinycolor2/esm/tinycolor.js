...
function inputToRGB(t) {
    ...
    if ('object' == _typeof(t)) {
        isValidCSSUnit(t.r) && isValidCSSUnit(t.g) && isValidCSSUnit(t.b)
            ? ((r = rgbToRgb(t.r, t.g, t.b)), (i = true), (s = '%' === String(t.r).substr(-1) ? 'prgb' : 'rgb'))
            : isValidCSSUnit(t.h) && isValidCSSUnit(t.s) && isValidCSSUnit(t.v)
            ? ((n = convertToPercentage(t.s)), (a = convertToPercentage(t.v)), (r = hsvToRgb(t.h, n, a)), (i = true), (s = 'hsv'))
            : isValidCSSUnit(t.h) &&
              isValidCSSUnit(t.s) &&
              isValidCSSUnit(t.l) &&
              ((n = convertToPercentage(t.s)), (o = convertToPercentage(t.l)), (r = hslToRgb(t.h, n, o)), (i = true), (s = 'hsl'));
...
function rgbToHsl(t, r, e) {
    ...
    var i = Math.min(t, r, e);
    var s = (o + i) / 2;
    if (o == i) {
        n = a = 0;
    } else {
        var h = o - i;
        switch (((a = s > 0.5 ? h / (2 - o - i) : h / (o + i)), o)) {
            case t:
                n = (r - e) / h + (r < e ? 6 : 0);
                break;
            case r:
...
function hslToRgb(t, r, e) {
    ...
    function i(t, r, e) {
        ...
        return e < 0.16666666666666666 ? t + 6 * (r - t) * e : e < 0.5 ? r : e < 0.6666666666666666 ? t + (r - t) * (0.6666666666666666 - e) * 6 : t;
    }
    t = bound01(t, 360);
    r = bound01(r, 100);
    e = bound01(e, 100);
    if (0 === r) {
        ...
        var h = 2 * e - s;
        n = i(h, s, t + 0.3333333333333333);
        a = i(h, s, t);
        o = i(h, s, t - 0.3333333333333333);
    }
    return {
        r: 255 * n,
        g: 255 * a,
...
function rgbToHex(t, r, e, n) {
    ...
    return n && a[0].charAt(0) == a[0].charAt(1) && a[1].charAt(0) == a[1].charAt(1) && a[2].charAt(0) == a[2].charAt(1)
        ? a[0].charAt(0) + a[1].charAt(0) + a[2].charAt(0)
        : a.join('');
}
function rgbaToHex(t, r, e, n, a) {
    var o = [pad2(Math.round(t).toString(16)), pad2(Math.round(r).toString(16)), pad2(Math.round(e).toString(16)), pad2(convertDecimalToHex(n))];
    return a && o[0].charAt(0) == o[0].charAt(1) && o[1].charAt(0) == o[1].charAt(1) && o[2].charAt(0) == o[2].charAt(1) && o[3].charAt(0) == o[3].charAt(1)
        ? o[0].charAt(0) + o[1].charAt(0) + o[2].charAt(0) + o[3].charAt(0)
        : o.join('');
}
function rgbaToArgbHex(t, r, e, n) {
    return [pad2(convertDecimalToHex(n)), pad2(Math.round(t).toString(16)), pad2(Math.round(r).toString(16)), pad2(Math.round(e).toString(16))].join('');
}
...
function polyad(t, r) {
    ...
    for (var e = tinycolor(t).toHsl(), n = [tinycolor(t)], a = 360 / r, o = 1; o < r; o++) {
        n.push(
            tinycolor({
                h: (e.h + o * a) % 360,
                s: e.s,
...
function _monochromatic(t, r) {
    r = r || 6;
    for (var e = tinycolor(t).toHsv(), n = e.h, a = e.s, o = e.v, i = [], s = 1 / r; r--; ) {
        i.push(
            tinycolor({
                h: n,
                s: a,
...
tinycolor.prototype = {
    ...
    getLuminance: function () {
        ...
        return (
            ...
            0.0722 * (e <= 0.03928 ? e / 12.92 : Math.pow((e + 0.055) / 1.055, 2.4))
        );
    },
    setAlpha: function (t) {
    ...
    toHsvString: function () {
        var t = rgbToHsv(this._r, this._g, this._b);
        var r = Math.round(360 * t.h);
        var e = Math.round(100 * t.s);
        var n = Math.round(100 * t.v);
    ...
    toPercentageRgbString: function () {
        return 1 == this._a
            ? 'rgb(' + Math.round(100 * bound01(this._r, 255)) + '%, ' + Math.round(100 * bound01(this._g, 255)) + '%, ' + Math.round(100 * bound01(this._b, 255)) + '%)'
            : 'rgba(' +
    ...
    toString: function (t) {
        ...
        return r || !n || ('hex' !== t && 'hex6' !== t && 'hex3' !== t && 'hex4' !== t && 'hex8' !== t && 'name' !== t)
            ? ('rgb' === t && (e = this.toRgbString()),
              'prgb' === t && (e = this.toPercentageRgbString()),
              ('hex' !== t && 'hex6' !== t) || (e = this.toHexString()),
              'hex3' === t && (e = this.toHexString(true)),
              'hex4' === t && (e = this.toHex8String(true)),
    ...
    if ('object' == _typeof(t)) {
        ...
        for (var n in t) {
            if (t.hasOwnProperty(n)) {
                e[n] = 'a' === n ? t[n] : convertToPercentage(t[n]);
            }
        }
        t = e;
    }
...
tinycolor.isReadable = function (t, r, e) {
    ...
    switch (((a = false), (n = validateWCAG2Parms(e)).level + n.size)) {
        case 'AAsmall':
        case 'AAAlarge':
            a = o >= 4.5;
            break;
...
tinycolor.mostReadable = function (t, r, e) {
    ...
    for (var l = 0; l < r.length; l++) {
        if ((n = tinycolor.readability(t, r[l])) > h) {
            h = n;
            s = tinycolor(r[l]);
        }
    }
    return tinycolor.isReadable(t, s, {
        level: o,
        size: i
    }) || !a
        ? s
        : ((e.includeFallbackColors = false), tinycolor.mostReadable(t, ['#fff', '#000'], e));
};
...
function bound01(t, r) {
    ...
    return Math.abs(t - r) < 0.000001 ? 1 : (t % r) / parseFloat(r);
}
function clamp01(t) {
...
function stringInputToObject(t) {
    ...
    return (r = matchers.rgb.exec(t))
        ? {
              r: r[1],
              g: r[2],
              b: r[3]
          }
        : (r = matchers.rgba.exec(t))
        ? {
              r: r[1],
              g: r[2],
              b: r[3],
        ...
        : (r = matchers.hsl.exec(t))
        ? {
              h: r[1],
              s: r[2],
              l: r[3]
          }
        : (r = matchers.hsla.exec(t))
        ? {
              h: r[1],
              s: r[2],
              l: r[3],
        ...
        : (r = matchers.hsv.exec(t))
        ? {
              h: r[1],
              s: r[2],
              v: r[3]
          }
        : (r = matchers.hsva.exec(t))
        ? {
              h: r[1],
              s: r[2],
              v: r[3],
...
function validateWCAG2Parms(t) {
    ...
    if ('small' !== (e = (t.size || 'small').toLowerCase()) && 'large' !== e) {
        e = 'small';
    }
    return {
        level: r,
