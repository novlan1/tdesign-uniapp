...
export function __decorate(decorators, target, key, desc) {
  let c = arguments.length; var r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc; var d;
...
export function __esDecorate(ctor, descriptorIn, decorators, contextIn, initializers, extraInitializers) {
 ...
 if (f !== void 0 && typeof f !== 'function') throw new TypeError('Function expected'); return f; 
  ...
  let {kind} = contextIn; var key = kind === 'getter' ? 'get' : kind === 'setter' ? 'set' : 'value';
...
export function __generator(thisArg, body) {
  let _ = { label: 0, sent() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }; var f; var y; var t; var g = Object.create((typeof Iterator === 'function' ? Iterator : Object).prototype);
...
export function __values(o) {
  let s = typeof Symbol === 'function' && Symbol.iterator; var m = s && o[s]; var i = 0;
...
export function __read(o, n) {
  ...
  if (!m) return o;
  let i = m.call(o); var r; var ar = []; var e;
  try {
...
export function __asyncGenerator(thisArg, _arguments, generator) {
  ...
  let g = generator.apply(thisArg, _arguments || []); var i; var q = [];
...
export function __asyncDelegator(o) {
  let i; var p;
  return i = {}, verb('next'), verb('throw', (e) => {
 throw e; 
...
export function __asyncValues(o) {
  if (!Symbol.asyncIterator) throw new TypeError('Symbol.asyncIterator is not defined.');
  let m = o[Symbol.asyncIterator]; var i;
...
let _SuppressedError = typeof SuppressedError === 'function' ? SuppressedError : function (error, suppressed, message) {
  ...
  function next() {
    while (r = env.stack.pop()) {
      try {
        ...
        if (r.dispose) {
          let result = r.dispose.call(r.value);
          if (r.async) return s |= 2, Promise.resolve(result).then(next, (e) => {
 fail(e); return next(); 
});
        } else s |= 1;
      } catch (e) {
...
export function __rewriteRelativeImportExtension(path, preserveJsx) {
  if (typeof path === 'string' && /^\.\.?\//.test(path)) {
    return path.replace(/\.(tsx)$|((?:\.d)?)((?:\.[^./]+?)?)\.([cm]?)ts$/i, (m, tsx, d, ext, cm) => {
