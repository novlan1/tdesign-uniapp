    ...
    <view>
        <view class="chat-box" :style="'height: ' + contentHeight + ';'">
            <t-chat>
                    ...
                    >
                        <view slot="content">
                            <block v-for="(contentItem, contentIndex) in item.message.content" :key="contentIndex">
                                ...
                                <view class="preview" :slot="'custom-' + contentIndex" v-if="contentItem.type === 'preview'">
                ...
                <view slot="footer">
                    <t-chat-sender :value="value" :loading="loading" :disabled="disabled" @send="onSend" @stop="onStop" @focus="onFocus" :autoRiseWithKeyboard="true" />
                </view>
            </t-chat>
        </view>
        <t-toast id="t-toast" />
