                    ...
                    >
                        <view slot="content">
                            <block v-for="(contentItem, contentIndex) in item.message.content" :key="contentIndex">
                                ...
                                <view class="step" v-if="contentItem.type === 'agent'">
                                    <t-steps layout="vertical" :current="contentItem.content.steps.length">
                                        <t-step-item :title="item.step" v-for="(item, index) in contentItem.content.steps" :key="index">
                                            <view slot="content" class="step-text-list">
                                                <view :class="'step-text ' + taskItem.type" v-for="(taskItem, index1) in item.tasks" :key="index1">
                                                    <t-icon v-if="taskItem.type === 'command'" name="control-platform" size="32rpx" class="step-icon" />
    ...
    methods: {
        attached: function () {
            ...
            try {
                ...
                this.setData({
                    contentHeightClone: contentHeight
                });
                ...
                this.setData({
                    contentHeightClone: 'calc(100vh - 96rpx)'
                });
            }
        },
